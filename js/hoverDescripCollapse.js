...
// 	for (i = 0; i < overlayProductDescriptionBlock.size(); i++) {
//
//
// 	if (width > 1071) {
// 		console.log("Window width is less than 1071px, collapsing menu.");
//
// 		 overlayProductDescriptionHover[i].classList.remove("hidden");
// 		 // overlayProductDescriptionHover.setAttribute("aria-hidden", "false");
// 		 overlayProductDescriptionBlock[i].classList.add("hidden");
...
// 	} else {
//
// 		overlayProductDescriptionHover[i].classList.add("hidden");
// 		// overlayProductDescriptionHover.setAttribute("aria-hidden", "true");
// 		overlayProductDescriptionBlock[i].classList.remove("hidden");
